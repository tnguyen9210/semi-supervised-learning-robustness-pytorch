...
class DeepModel(object):
    ...
    def update(self, train_unlbl, train_lbl, epoch, logger):
        ...
        for i in range(self.num_iters_per_epoch):
            ...
            unlbl_x1, unlbl_x2 = train_unlbl_iter.next()
            ...
            unlbl_x1 = unlbl_x1.to(self.device)
            unlbl_x2 = unlbl_x2.to(self.device)

            # mix-match lbl and unlbl batches
            unlbl_logit, unlbl_yhat, lbl_logit, lbl_yhat = self.mix_match(
                self.net, unlbl_x1, unlbl_x2, lbl_x, lbl_y)
            ...
            loss = lbl_loss + self.consis_coef*unlbl_loss
