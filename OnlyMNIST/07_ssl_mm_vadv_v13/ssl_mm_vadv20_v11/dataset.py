...
def load_data(domain, data_dir, img_size, num_iters_per_epoch, batch_size):
    ...
    # load data
    train_unlbl = ImageDatasetUnlbl(data_dir, domain, img_size, ds='train_unlbl_100', transform=train_transform)
    train_lbl = ImageDataset(data_dir, domain, img_size, ds='train_lbl_100', transform=train_transform)
