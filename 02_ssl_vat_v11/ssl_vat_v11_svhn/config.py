...
def parse_args():
    ...
    # Training
    parser.add_argument('--num_epochs', type=int, default=70, help="Number of total training epochs.")
    ...
    parser.add_argument('--vat_xi', type=float, default=0.1)
    ...
    parser.add_argument('--resnet_group1_droprate', type=float, default=0.5)
    parser.add_argument('--resnet_group2_droprate', type=float, default=0.5)
    parser.add_argument('--resnet_group3_droprate', type=float, default=0.5)
